...
BEGIN
  INSERT INTO "FieldApp_farm_field_log"
    (log_timestamp, field_id_id, field_latitude, field_longitude, field_user_define1, field_user_define2)
  VALUES
    (now(), NEW.field_id, NEW.field_latitude, NEW.field_longitude, NEW.field_user_define1, NEW.field_user_define2);
END;
