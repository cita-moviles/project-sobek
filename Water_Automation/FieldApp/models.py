...
class Valve(models.Model):
    ...
    valve_flow = models.FloatField(null=True, blank=True)
    valve_pressure = models.FloatField(null=True, blank=True)
    valve_limit = models.FloatField(null=True, blank=True)
    valve_ideal = models.FloatField(null=True, blank=True)
